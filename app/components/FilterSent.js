...
const FilterSent = ({emails, filteredEmails, setFilteredEmails}) => {
  ...
  return (
    <div className='relative rounded-full mx-auto p-2 text-black'>
        ...
        {openFilter ?
        <form type = "submit" onChange={handleChange} className='bg-[#c2e7ff] w-[70%]  text-center p-4 mx-auto  space-y-2 '>
